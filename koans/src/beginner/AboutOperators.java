...
public class AboutOperators {
	...
	public void dontMistakeEqualsForEqualsEquals() {
		...
		assertEquals(a, true);
		assertEquals(i, 2);
		// How could you write the condition 'with a twist' to avoid this trap? use == and set a in the statement?
	}
	...
	public void aboutBitShiftingLeftShift() {
		int leftShift = 0x80000000; // Is this number positive or negative? negative, since the highest-order bit is flipped
	...
	public void aboutBitShiftingRightUnsigned() {
		...
		assertEquals(rightShiftNegativeStaysNegative, -1 * 0x08000000);
