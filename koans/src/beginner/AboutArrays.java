...
public class AboutArrays {
	...
	@Koan
	public void cloneEqualityIsNotRespected(){ //! this seems expected - pointers are not magic
	...
	public void anArraysHashCodeMethodDoesNotConsiderElements(){
		...
		assertEquals(Integer.valueOf(array0.hashCode()).equals(array1.hashCode()), false); // not equal! now THIS is retarded
	...
	public void arraysAreMutable(){
		...
		oneBoolean[0] = true;
		assertEquals(oneBoolean[0], true); //this is upsetting
	}
